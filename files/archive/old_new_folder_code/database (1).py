...
# This points to a real file, "flood_data.db", saved in the same folder as this
# script. This is what actually gives you persistence: readings survive a
# server restart, and you can inspect the file later (e.g. with DB Browser for
# SQLite) to show historical data during your defense.
DB_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "flood_data.db")
SQLALCHEMY_DATABASE_URL = f"sqlite:///{DB_FILE}"

# 2. Create the Database Engine.
# check_same_thread=False is still needed because FastAPI can serve requests
# from different threads, and SQLite's default is stricter than that.
